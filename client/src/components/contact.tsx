      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-charcoal max-w-3xl mx-auto">
            Ready to experience premium wellbeing solutions? Let's start your journey together.
          </p>
        </div>
        
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            <h3 className="text-2xl font-bold text-burgundy mb-8">Get In Touch</h3>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-charcoal">Ho Chi Minh City, Vietnam</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-charcoal">+84 (0) 123 456 789</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-charcoal">info@ggcvietnam.com.vn</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <Button size="icon" className="bg-burgundy hover:bg-dark-burgundy text-white rounded-lg">
                  <Facebook size={20} />
                </Button>
                <Button size="icon" className="bg-burgundy hover:bg-dark-burgundy text-white rounded-lg">
                  <Linkedin size={20} />
          ...
          <Card className="bg-warm-beige rounded-2xl border-0">
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="service" className="block text-charcoal font-medium mb-2">Service Interest</label>
                  <Select value={formData.service} onValueChange={(value) => handleInputChange('service', value)}>
                    ...
                    <SelectContent>
                      <SelectItem value="medical-wellness">Medical Wellness</SelectItem>
                      <SelectItem value="premium-automotive">Premium Automotive Solutions</SelectItem>
                      <SelectItem value="selective-healthcare">Selective Healthcare Services</SelectItem>
                      <SelectItem value="ai-smart-systems">AI & Smart Systems</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
